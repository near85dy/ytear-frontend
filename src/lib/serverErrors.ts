...
const localizedMessages: Record<Lang, Record<string, string>> = {
  lv: {
    ...
    'Вы не являетесь участником этого сообщества': 'Jūs neesat šīs kopienas dalībnieks',
    ...
    'Пользователь с таким email уже существует': 'Lietotājs ar šādu e-pastu jau pastāv',
    'Пользователь с таким именем уже существует': 'Lietotājs ar šādu vārdu jau pastāv',
    ...
    'Вы уже поставили лайк этому посту': 'Jūs jau atzīmējāt šo ierakstu ar patīk',
    ...
    'Только владелец может удалить сообщество': 'Tikai īpašnieks var dzēst kopienu',
    'Нельзя изменить роль владельца': 'Īpašnieka lomu nevar mainīt',
    'Только админы могут изменять роли': 'Tikai administratori var mainīt lomas',
    'Участник не найден': 'Dalībnieks nav atrasts',
    'Вы не можете изменить роль другого админа': 'Jūs nevarat mainīt cita administratora lomu',
    'Нельзя удалить владельца': 'Īpašnieku nevar dzēst',
    'Модератор не может удалить админа': 'Moderators nevar dzēst administratoru',
    ...
    'Вы не можете редактировать этот комментарий': 'Jūs nevarat rediģēt šo komentāru',
    ...
    'Имя пользователя должно быть не менее 3 символов': 'Lietotājvārdam jābūt vismaz 3 simbolus garam',
    'Имя пользователя должно быть не более 30 символов': 'Lietotājvārdam jābūt ne garākam par 30 simboliem',
    'Имя пользователя может содержать только буквы, цифры и подчёркивание': 'Lietotājvārds drīkst saturēt tikai burtus, ciparus un pasvītrojumu',
    'Пароль должен быть не менее 6 символов': 'Parolei jābūt vismaz 6 simbolus garai',
    'Пароль должен быть не более 100 символов': 'Parolei jābūt ne garākai par 100 simboliem',
    'Новый пароль должен быть не менее 6 символов': 'Jaunajai parolei jābūt vismaz 6 simbolus garai',
    'Новый пароль должен быть не более 100 символов': 'Jaunajai parolei jābūt ne garākai par 100 simboliem',
    'Неверная роль': 'Nederīga loma',
    'Пост не может быть пустым': 'Ieraksts nevar būt tukšs',
    'Пост должен быть не более 10000 символов': 'Ieraksts nedrīkst būt garāks par 10000 simboliem',
    'Комментарий не может быть пустым': 'Komentārs nevar būt tukšs',
    'Комментарий должен быть не более 5000 символов': 'Komentārs nedrīkst būt garāks par 5000 simboliem',
    'Название должно быть не менее 2 символов': 'Nosaukumam jābūt vismaz 2 simbolus garam',
    'Название должно быть не более 100 символов': 'Nosaukumam jābūt ne garākam par 100 simboliem',
    'Slug должен быть не менее 2 символов': 'Slug jābūt vismaz 2 simbolus garam',
    'Slug должен быть не более 50 символов': 'Slug nedrīkst būt garāks par 50 simboliem',
    'Slug может содержать только строчные буквы, цифры, дефис и подчёркивание': 'Slug drīkst saturēt tikai mazos burtus, ciparus, domuzīmi un pasvītrojumu',
    'Описание должно быть не более 1000 символов': 'Apraksts nedrīkst būt garāks par 1000 simboliem',
    'Неверный тип сообщества': 'Nederīgs kopienas tips',
    'Биография должна быть не более 500 символов': 'Biogrāfija nedrīkst būt garāka par 500 simboliem',
  ...
  en: {
    ...
    'Вы не являетесь участником этого сообщества': 'You are not a member of this community',
    ...
    'Сообщество с таким slug уже существует': 'A community with this slug already exists',
    'Вы уже являетесь участником': 'You are already a member',
    'Только владелец может удалить сообщество': 'Only the owner can delete the community',
    ...
    'Вы не можете изменить роль другого админа': 'You cannot change another admin’s role',
    ...
    'Вы не можете редактировать этот комментарий': 'You cannot edit this comment',
    ...
    'Имя пользователя должно быть не менее 3 символов': 'Username must be at least 3 characters long',
    'Имя пользователя должно быть не более 30 символов': 'Username must be at most 30 characters long',
    'Имя пользователя может содержать только буквы, цифры и подчёркивание': 'Username may contain only letters, digits and underscore',
    'Пароль должен быть не менее 6 символов': 'Password must be at least 6 characters long',
    'Пароль должен быть не более 100 символов': 'Password must be at most 100 characters long',
    'Новый пароль должен быть не менее 6 символов': 'New password must be at least 6 characters long',
    'Новый пароль должен быть не более 100 символов': 'New password must be at most 100 characters long',
    'Неверная роль': 'Invalid role',
    'Пост не может быть пустым': 'Post cannot be empty',
    'Пост должен быть не более 10000 символов': 'Post must be at most 10000 characters long',
    'Комментарий не может быть пустым': 'Comment cannot be empty',
    'Комментарий должен быть не более 5000 символов': 'Comment must be at most 5000 characters long',
    'Название должно быть не менее 2 символов': 'Name must be at least 2 characters long',
    'Название должно быть не более 100 символов': 'Name must be at most 100 characters long',
    'Slug должен быть не менее 2 символов': 'Slug must be at least 2 characters long',
    'Slug должен быть не более 50 символов': 'Slug must be at most 50 characters long',
    'Slug может содержать только строчные буквы, цифры, дефис и подчёркивание': 'Slug may contain only lowercase letters, digits, hyphen and underscore',
    'Описание должно быть не более 1000 символов': 'Description must be at most 1000 characters long',
    'Неверный тип сообщества': 'Invalid community type',
    'Биография должна быть не более 500 символов': 'Bio must be at most 500 characters long',
...
function extractMessages(payload: unknown): string[] {
  ...
  if (payload && typeof payload === 'object') {
    ...
    if (Array.isArray(message)) return message.flatMap((item) => extractMessages(item))
  }
  return []
}
